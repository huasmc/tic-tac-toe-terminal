...
class TestHumanVsBot(unittest.TestCase):
    ...
    def test_human_vs_bot_inherits_start_method(self):
    ...
    def test_human_vs_bot_player_two_is_bot_player_instance(self):
    ...
    @patch('sys.stdout', new_callable=StringIO)
    def test_human_vs_bot_ends_game_when_token_O_wins(self, mock_stdout):
    ...
    @patch('sys.stdout', new_callable=StringIO)
    def test_human_vs_bot_ends_game_when_token_X_wins(self, mock_stdout):
        self.game.board.grid = ["X", "O", "X",
                                "O", "X", "O",
                                "O", "O", "X"]
        self.game.end_game()
